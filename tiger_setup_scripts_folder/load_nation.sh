TMPDIR="/home/dheeraj_ck/pingintel/gisfolder/temp/"
UNZIPTOOL=unzip
...
PSQL=/usr/bin/psql
SHP2PGSQL=shp2pgsql
cd /home/dheeraj_ck/pingintel/gisfolder

cd /home/dheeraj_ck/pingintel/gisfolder
wget https://www2.census.gov/geo/tiger/TIGER2022/STATE/tl_2022_us_state.zip --mirror --reject=html
cd /home/dheeraj_ck/pingintel/gisfolder/www2.census.gov/geo/tiger/TIGER2022/STATE
rm -f ${TMPDIR}/*.*
...
cd /home/dheeraj_ck/pingintel/gisfolder/www2.census.gov/geo/tiger/TIGER2022/COUNTY
rm -f ${TMPDIR}/*.*
${PSQL} -c "DROP SCHEMA IF EXISTS tiger_staging CASCADE;"
${PSQL} -c "CREATE SCHEMA tiger_staging;"
